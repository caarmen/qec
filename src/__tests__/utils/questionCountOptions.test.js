...
describe("questionCountOptions", () => {
  describe("getAvailableQuestionCountOptions", () => {
    ...
    it("throws when options contain invalid values", () => {
      ...
      expect(() => getAvailableQuestionCountOptions(50, [10, 0, 40])).toThrow(
        "options must contain only positive, finite numbers",
      );

      expect(() => getAvailableQuestionCountOptions(50, [10, -20, 40])).toThrow(
        "options must contain only positive, finite numbers",
      );
    });
