...
describe("SegmentedControlOption", () => {
  ...
  describe("rendering", () => {
    ...
    it("should apply additional className", () => {
      render(
        <SegmentedControlOption {...defaultProps} className="custom-class" />,
      );
  ...
  describe("interaction", () => {
    it("should call onSelect with value when clicked", async () => {
      ...
      render(
        <SegmentedControlOption {...defaultProps} onSelect={handleSelect} />,
      );
    ...
    it("should forward onKeyDown handler", async () => {
      ...
      render(
        <SegmentedControlOption {...defaultProps} onKeyDown={handleKeyDown} />,
      );
