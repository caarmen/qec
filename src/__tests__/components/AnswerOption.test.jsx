...
describe("AnswerOption", () => {
  ...
  describe("rendering", () => {
    it("should render answer text", () => {
      ...
      expect(
        screen.getByRole("radio", { name: /test answer/i }),
      ).toBeInTheDocument();
    });
    ...
    it("should render with long text", () => {
      const longText =
        "This is a very long answer text that should wrap properly within the card component without breaking the layout or causing any display issues.";
  ...
  describe("interaction", () => {
    ...
    it("should not call onSelect when disabled", async () => {
      ...
      render(
        <AnswerOption {...defaultProps} onSelect={handleSelect} disabled />,
      );
  ...
  describe("accessibility", () => {
    ...
    it("should have proper aria-checked attribute", () => {
      const { rerender } = render(
        <AnswerOption {...defaultProps} isSelected={false} />,
      );
