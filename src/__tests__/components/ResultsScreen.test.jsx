...
describe('ResultsScreen', () => {
  ...
  describe('score calculation', () => {
    it('should calculate percentage correctly for perfect score', () => {
      render(<ResultsScreen score={10} totalQuestions={10} onRestart={vi.fn()} />)
      
      expect(screen.getByText(/score : 100%/i)).toBeInTheDocument()
    })

    it('should calculate percentage correctly for zero score', () => {
      render(<ResultsScreen score={0} totalQuestions={10} onRestart={vi.fn()} />)
      
      expect(screen.getByText(/score : 0%/i)).toBeInTheDocument()
    })

    it('should calculate percentage correctly for partial score', () => {
      render(<ResultsScreen score={5} totalQuestions={10} onRestart={vi.fn()} />)
      
      expect(screen.getByText(/score : 50%/i)).toBeInTheDocument()
    })

    it('should round percentage to nearest integer', () => {
      render(<ResultsScreen score={1} totalQuestions={3} onRestart={vi.fn()} />)
    ...
    it('should handle different total questions', () => {
      render(<ResultsScreen score={15} totalQuestions={20} onRestart={vi.fn()} />)
    ...
    it('should calculate percentage for single question quiz', () => {
      render(<ResultsScreen score={1} totalQuestions={1} onRestart={vi.fn()} />)
  ...
  describe('interaction', () => {
    it('should call onRestart when button is clicked', async () => {
      ...
      const button = screen.getByRole('button', { name: /recommencer le quiz/i })
  ...
  describe('content variations', () => {
    it('should display low score results', () => {
      render(<ResultsScreen score={2} totalQuestions={10} onRestart={vi.fn()} />)
    ...
    it('should display high score results', () => {
      render(<ResultsScreen score={9} totalQuestions={10} onRestart={vi.fn()} />)
    ...
    it('should display results for different quiz lengths', () => {
      render(<ResultsScreen score={4} totalQuestions={5} onRestart={vi.fn()} />)
